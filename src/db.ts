...
export async function searchProperties(filters: {
    ...
    if (filters.square_footage_min) { query = query.gte('square_footage', filters.square_footage_min); }
    if (filters.square_footage_max) { query = query.lte('square_footage', filters.square_footage_max); }
